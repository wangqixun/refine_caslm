...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_train2017_coco80.json',
        img_prefix=data_root + 'train2017/',
        seg_prefix=data_root + 'train2017/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotationInCOCOReformat_val_coco80_polygon.json',
        img_prefix='/share/yanzhen/tools/internal-data/0425/0512/dataset/new/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file='/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_test_coco80.json',
...
# resume_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_cb2_swimtiny_coco80/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_cb2_swimtiny_coco80'
