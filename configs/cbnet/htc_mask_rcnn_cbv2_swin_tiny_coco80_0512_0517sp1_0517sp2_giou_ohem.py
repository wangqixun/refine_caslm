...
train_data = [
    ...
    dict(
        type=dataset_type,
        classes=classes,
        ann_file='/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_train_xhs9_0517sp1.json',
        img_prefix='/share/yanzhen/tools/internal-data/0517/annotations/split1/dataset/new/',
        pipeline=train_pipeline
    ),
    dict(
        type=dataset_type,
...
data = dict(
    ...
    #     # dataset=dict(
    #     #     type=dataset_type,
    #     #     ann_file='/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_train_coco80_polygon.json',
    #     #     img_prefix='/share/yanzhen/tools/internal-data/0425/0512/dataset/new/',
...
load_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_cb2_swimtiny_coco80/epoch_13.pth'
# resume_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_cb2_swimtiny_coco80/epoch_5.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_mask_rcnn_cb2_swimtiny_coco80_0512_0517sp1_0517sp2_ms_giou_ohem'
