    ...
    roi_head=dict(
        ...
        mask_head=dict(
            type='RefineMaskHead',
                 ...
                 mask_predictor_cfg=dict(type='NormedConv2d', tempearture=20),
...
# resume_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80_0512_0517sp1_full_0517sp2_0517sp3_giou_ohem_bigsize_coloraug_copypaste/latest.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80_0512_0517sp1_full_0517sp2_0517sp3_giou_ohem_bigsize_coloraug_copypaste_normmask'
