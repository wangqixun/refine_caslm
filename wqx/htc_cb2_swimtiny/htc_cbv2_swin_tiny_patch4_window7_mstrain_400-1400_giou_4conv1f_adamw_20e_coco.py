...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/share/data/coco/annotations/instances_train2017.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/share/data/coco/annotations/instances_val2017.json',
...
workflow = [('train', 1)]
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_cb2_swimtiny'
gpu_ids = range(0, 8)
