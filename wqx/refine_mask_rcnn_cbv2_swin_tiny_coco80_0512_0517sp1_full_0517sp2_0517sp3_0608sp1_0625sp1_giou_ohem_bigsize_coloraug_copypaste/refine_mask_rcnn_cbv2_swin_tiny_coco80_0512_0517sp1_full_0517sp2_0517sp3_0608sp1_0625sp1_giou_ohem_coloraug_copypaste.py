    ...
    train=dict(
        ...
        dataset=[
            dict(
                ...
                classes=[
                    'person', 'bicycle', 'motorcycle', 'frisbee', 'snowboard',
                    'sports ball', 'baseball bat', 'skateboard',
                    'tennis racket'
                ],
                ann_file=
                '/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_train_xhs9_0512.json',
            ...
            dict(
                ...
                ann_file=
                '/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_train_xhs9_0608sp1.json',
                img_prefix=
                '/share/yanzhen/tools/internal-data/0608/annotations/dataset/new/',
                pipeline=[
                    dict(type='LoadImageFromFile', to_float32=True),
                    dict(type='PhotoMetricDistortion'),
                    dict(
            ...
            dict(
                ...
                ann_file=
                '/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_train_xhs9_0625sp1.json',
                img_prefix=
                '/share/yanzhen/tools/internal-data/0625/annotations/dataset/new/',
                pipeline=[
                    dict(type='LoadImageFromFile', to_float32=True),
                    dict(type='PhotoMetricDistortion'),
                    dict(
...
log_level = 'INFO'
workflow = [('train', 1)]
load_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80/latest.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80_0512_0517sp1_full_0517sp2_0517sp3_0608sp1_0625sp1_giou_ohem_bigsize_coloraug_copypaste'
gpu_ids = range(0, 8)
