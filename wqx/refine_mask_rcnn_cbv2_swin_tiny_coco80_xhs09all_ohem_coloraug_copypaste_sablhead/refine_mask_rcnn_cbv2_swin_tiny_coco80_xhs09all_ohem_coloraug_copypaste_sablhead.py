...
log_level = 'INFO'
workflow = [('train', 1)]
load_from = 'wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80/latest.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80_xhs09all_ohem_coloraug_copypaste_sablhead'
gpu_ids = range(0, 8)
