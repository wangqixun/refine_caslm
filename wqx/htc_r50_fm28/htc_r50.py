...
log_level = 'INFO'
workflow = [('train', 1)]
load_from = '/share/wangqixun/workspace/github_project/mmdetection/model_dl/htc_r50_fpn_20e_coco_20200319-fe28c577.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htc_r50_fm28'
gpu_ids = range(0, 6)
