...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=20.0),
...
train_data = [
    ...
    dict(
        ...
        ann_file=
        '/share/wangqixun/workspace/github_project/CBNetV2_train/data/annotationInCOCOReformat_train_xhs9_0517sp1_full_wo_person.json',
        img_prefix=
        '/share/wangqixun/workspace/github_project/CBNetV2_train/data/images/train_xhs9_0517sp1_full_wo_person/',
        pipeline=[
            dict(
                type='Normalize',
                mean=[123.675, 116.28, 103.53],
...
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/mask_rcnn_cb2_swimtiny_coco80_0512_0517sp1_full_0517sp2_0517sp1_full_wo_person_ms_giou_fm28_clsfix'
gpu_ids = range(0, 8)
