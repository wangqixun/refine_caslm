...
log_level = 'INFO'
workflow = [('train', 1)]
load_from = '/share/wangqixun/workspace/github_project/mmdetection/model_dl/mask_rcnn_swin_tiny_patch4_window7.pth'
resume_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/v1_refinemask_onebackbone/latest.pth'
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/v1_refinemask_onebackbone'
gpu_ids = range(0, 8)
