...
log_level = 'INFO'
workflow = [('train', 1)]
load_from = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/u2mask_rcnn_cbv2_swin_tiny_patch4_window7_mstrain_480-800_adamw_3x_coco/epoch_36.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/github_project/CBNetV2_train/wqx/htcu2mask_rcnn_cbv2_swin_tiny_coco80_0512_0517sp1_full_0517sp2_0517sp3_giou_ohem_bigsize_coloraug'
gpu_ids = range(0, 8)
