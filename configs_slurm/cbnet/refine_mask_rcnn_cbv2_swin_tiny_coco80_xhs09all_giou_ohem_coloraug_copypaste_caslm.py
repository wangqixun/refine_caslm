        ...
        train=dict(
            ...
            dataset=[
                ...
                dict(
                    type=dataset_type,
                    classes=classes,
                    ann_file='/mnt/mmtech01/dataset/v_cocomask/ann/annotationInCOCOReformat_train_xhs9_0608sp1.json',
                    img_prefix='/mnt/mmtech01/dataset/v_cocomask/images/xhs9_0608sp1/',
                    pipeline=load_pipeline,
                ),
                dict(
                    type=dataset_type,
                    classes=classes,
                    ann_file='/mnt/mmtech01/dataset/v_cocomask/ann/annotationInCOCOReformat_train_xhs9_0625sp1.json',
                    img_prefix='/mnt/mmtech01/dataset/v_cocomask/images/xhs9_0625sp1/',
                    pipeline=load_pipeline,
                ),
                dict(
                    type=dataset_type,
                    classes=classes,
                    ann_file='/mnt/mmtech01/dataset/v_cocomask/ann/annotationInCOCOReformat_train_xhs9_0628sp3.json',
                    img_prefix='/mnt/mmtech01/dataset/v_cocomask/images/xhs9_0628sp3/',
                    pipeline=load_pipeline,
                ),
...
mnt_input_dir = ''
mnt_output_dir = '/mnt/mmtech01/usr/guiwan/workspace/instance_segm/wqx'
load_from = '/mnt/mmtech01/usr/guiwan/workspace/instance_segm/wqx/refine_mask_rcnn_cbv2_swin_tiny_coco80_caslm/epoch_36.pth'
...
resume_from = None
work_dir = f"{mnt_output_dir}/refine_mask_rcnn_cbv2_swin_tiny_coco80_xhs09all_giou_ohem_coloraug_copypaste_caslm" 
